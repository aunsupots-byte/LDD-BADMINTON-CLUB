...
รอบนี้ย้ายมาให้เฉพาะฟีเจอร์หลักที่พิสูจน์ว่าทั้งระบบ (GitHub → Render → Google Sheets API → Redis) เดินได้จริงก่อน:
...
**ยังไม่ได้ย้ายมาในรอบนี้:** Walk-in, จัดคิวสนามเรียลไทม์, ขายของ/ซื้อลูกแบด, ปิดสนามประจำวันอัตโนมัติ, รายงาน PDF ส่ง Drive, ตั้งค่าเสาร์-อาทิตย์, โลโก้/พื้นหลัง, ระบบถอนรายชื่อ ฯลฯ — พอทดสอบรอบนี้ผ่านแล้ว แจ้งได้เลย จะทยอยย้ายเพิ่มให้ครบทีละฟีเจอร์
